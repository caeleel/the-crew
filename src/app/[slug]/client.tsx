...
import { Card, Hand, Signal } from '../components/cards'
...
import { Button, EmoteButton, emotes, SignalButton } from '../components/button'
import { signalType } from '../game-logic/hint'
import { pickSeat } from '../lib/utils'
import {
  CardValue,
  CardWithPosition,
  Hint,
...
import { atomStore } from '../game-logic/game'
      ...
      <div className="flex gap-2 items-center">
        <div className="relative">
          {emote === 'distress' ? (
            ...
            <img src={`/${seatAvatar[seat]}.svg`} className="select-none" />
          )}
          {seat === gameState.captainSeat && (
            ...
            >
              <img src={'/crown.png'} className="w-8 h-8 select-none" />
            </div>
          )}
        </div>
        <div className="flex items-center">
          <div>
            <img src="/triangle.svg" className="select-none" />
          </div>
...
function connectOnce(channel: string) {
  if (hadConnected) return
...
function ClientInner() {
  ...
  return (
    <>
      <GameHeader />
      <div className="flex flex-col py-2 gap-8 items-center justify-center">
